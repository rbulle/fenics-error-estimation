...
try:
    marker_x, marker_y = marker(df_bw["num_dofs"].values, [df_bw['error_res'].values, df_bw['error_zz'].values, df_bw['error_exact'].values, df_bw["error_bw"].values, df_bw["error_res"].values], 0.4, 0.1)
except:
    marker_x, marker_y = marker(df_bw["num_dofs"].values, [df_bw['error_res'].values, df_bw['error_exact'].values, df_bw["error_bw"].values, df_bw["error_res"].values], 0.4, 0.1)

annotation.slope_marker((marker_x, marker_y), (-k, 3), invert=True)
